...
namespace AdvComProject
{
    ...
    public sealed partial class Feedback : Page
    {
        ...
        async void sendEmail()
        {
            ...
            em.To.Add(new EmailRecipient("go.4.0.app@gmail.com"));
            em.Subject = "A feedback from "+emailbox.Text;
            em.Body = feedbox.Text;
        ...
        {
            var messageDialog = new MessageDialog("Thank you for your feedback.\nWe really appreciated it!");
